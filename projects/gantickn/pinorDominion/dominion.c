...
int j = state->hand[currentPlayer][choice1];  //store card we will trash
        ...
        {
            printf("This is not a treasure. Error.\n");
            return -1;
        }
        ...
        {   
            printf("The increase in value is too large. Error.\n");
            return -1;
        }
...
int j = 0;		//used to check if player has enough cards to discard
        ...
        if (choice1 == handPos)
        {
            ...
            printf("This is an illegal operation. Error\n");
            return -1;
        }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        newMine(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
        return 0;
    ...
    case baron:
      newBaron(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
        return 0;
    ...
    case minion:
       newMinion(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);
       return 0;
    ...
    case tribute:
      newTribute(choice1, choice2, choice3, state, handPos, bonus, currentPlayer, tributeRevealedCards);  
        return 0;

    case ambassador:
      newAmbassador(choice1, choice2, choice3, state, handPos, bonus, currentPlayer);  
        return 0;
